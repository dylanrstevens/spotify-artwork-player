...
import warnings
import webbrowser
from settings_window import AuthenticatePage
...
class SpotifyOAuth(SpotifyAuthBase):
    ...
    def _get_auth_response_interactive(self, open_browser=False):
        if open_browser:
            ...
            if (self.instance.frames[AuthenticatePage].linkEntered.get() != "app_closed"):
                self._open_auth_url()
        else:
            url = self.get_authorize_url()
        response = self.instance.frames[AuthenticatePage].getLinkInput()
